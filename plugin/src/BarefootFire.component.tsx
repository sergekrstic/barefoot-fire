...
export function BarefootFireComponent({
	settings,
}: BarefootFireComponentProps): JSX.Element {
	...
	useEffect(() => {
		const fetchCategories = async (): Promise<void> => {
			...
			const categoryTitles = response.data.map(
	...
	return (
		<div className="fire-container">
			<div className="fire-title">
				<h4>Barefoot FIRE</h4>
				<button
					onMouseDown={(): void => setShowContent(true)}
					onMouseUp={(): void => setShowContent(false)}
				>
