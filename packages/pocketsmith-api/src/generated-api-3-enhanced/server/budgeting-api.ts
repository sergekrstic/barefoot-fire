...
export const BudgetingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        usersIdBudgetGet: async (id: number, rollUp?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('usersIdBudgetGet', 'id', id)
            const localVarPath = `/users/{id}/budget`
         ...
         * @throws {RequiredError}
         */
        usersIdBudgetSummaryGet: async (id: number, period: UsersIdBudgetSummaryGetPeriod, interval: number, startDate: string, endDate: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            ...
            const localVarPath = `/users/{id}/budget_summary`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        usersIdForecastCacheDelete: async (id: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/users/{id}/forecast_cache`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        usersIdTrendAnalysisGet: async (id: number, period: UsersIdTrendAnalysisGetPeriod, interval: number, startDate: string, endDate: string, categories: string, scenarios: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            ...
            const localVarPath = `/users/{id}/trend_analysis`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const BudgetingApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async usersIdBudgetGet(id: number, rollUp?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<BudgetAnalysisPackage>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.usersIdBudgetGet(id, rollUp, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['BudgetingApi.usersIdBudgetGet']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async usersIdBudgetSummaryGet(id: number, period: UsersIdBudgetSummaryGetPeriod, interval: number, startDate: string, endDate: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<BudgetAnalysisPackage>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.usersIdBudgetSummaryGet(id, period, interval, startDate, endDate, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['BudgetingApi.usersIdBudgetSummaryGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Delete the user\'s cached forecast by recalculating the forecast.
         ...
         * @throws {RequiredError}
         */
        async usersIdForecastCacheDelete(id: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.usersIdForecastCacheDelete(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['BudgetingApi.usersIdForecastCacheDelete']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Get an income and/or expense budget analysis for the given date range and period across any number of categories and scenarios. Akin to the Trends page in PocketSmith.
         ...
         * @throws {RequiredError}
         */
        async usersIdTrendAnalysisGet(id: number, period: UsersIdTrendAnalysisGetPeriod, interval: number, startDate: string, endDate: string, categories: string, scenarios: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<BudgetAnalysisPackage>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.usersIdTrendAnalysisGet(id, period, interval, startDate, endDate, categories, scenarios, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['BudgetingApi.usersIdTrendAnalysisGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const BudgetingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        usersIdBudgetGet(requestParameters: BudgetingApiUsersIdBudgetGetRequest, options?: RawAxiosRequestConfig): AxiosPromise<Array<BudgetAnalysisPackage>> {
            return localVarFp.usersIdBudgetGet(requestParameters.id, requestParameters.rollUp, options).then((request) => request(axios, basePath));
        },
        /**
         * Get the user\'s budget summary, containing an expense and income analysis for all categories (excluding transfer categories) for the given period and date range. Akin to the overall budget shown on the Budget page in PocketSmith.
         * @summary Get budget summary for user
         ...
         * @throws {RequiredError}
         */
        usersIdBudgetSummaryGet(requestParameters: BudgetingApiUsersIdBudgetSummaryGetRequest, options?: RawAxiosRequestConfig): AxiosPromise<Array<BudgetAnalysisPackage>> {
            return localVarFp.usersIdBudgetSummaryGet(requestParameters.id, requestParameters.period, requestParameters.interval, requestParameters.startDate, requestParameters.endDate, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete the user\'s cached forecast by recalculating the forecast.
         * @summary Delete forecast cache for user
         ...
         * @throws {RequiredError}
         */
        usersIdForecastCacheDelete(requestParameters: BudgetingApiUsersIdForecastCacheDeleteRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.usersIdForecastCacheDelete(requestParameters.id, options).then((request) => request(axios, basePath));
        },
        /**
         * Get an income and/or expense budget analysis for the given date range and period across any number of categories and scenarios. Akin to the Trends page in PocketSmith.
         * @summary Get trend analysis for user
         ...
         * @throws {RequiredError}
         */
        usersIdTrendAnalysisGet(requestParameters: BudgetingApiUsersIdTrendAnalysisGetRequest, options?: RawAxiosRequestConfig): AxiosPromise<Array<BudgetAnalysisPackage>> {
            return localVarFp.usersIdTrendAnalysisGet(requestParameters.id, requestParameters.period, requestParameters.interval, requestParameters.startDate, requestParameters.endDate, requestParameters.categories, requestParameters.scenarios, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class BudgetingApi extends BaseAPI {
    ...
    public usersIdBudgetGet(requestParameters: BudgetingApiUsersIdBudgetGetRequest, options?: RawAxiosRequestConfig) {
        return BudgetingApiFp(this.configuration).usersIdBudgetGet(requestParameters.id, requestParameters.rollUp, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof BudgetingApi
     */
    public usersIdBudgetSummaryGet(requestParameters: BudgetingApiUsersIdBudgetSummaryGetRequest, options?: RawAxiosRequestConfig) {
        return BudgetingApiFp(this.configuration).usersIdBudgetSummaryGet(requestParameters.id, requestParameters.period, requestParameters.interval, requestParameters.startDate, requestParameters.endDate, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof BudgetingApi
     */
    public usersIdForecastCacheDelete(requestParameters: BudgetingApiUsersIdForecastCacheDeleteRequest, options?: RawAxiosRequestConfig) {
        return BudgetingApiFp(this.configuration).usersIdForecastCacheDelete(requestParameters.id, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof BudgetingApi
     */
    public usersIdTrendAnalysisGet(requestParameters: BudgetingApiUsersIdTrendAnalysisGetRequest, options?: RawAxiosRequestConfig) {
        return BudgetingApiFp(this.configuration).usersIdTrendAnalysisGet(requestParameters.id, requestParameters.period, requestParameters.interval, requestParameters.startDate, requestParameters.endDate, requestParameters.categories, requestParameters.scenarios, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export type UsersIdBudgetSummaryGetPeriod = typeof UsersIdBudgetSummaryGetPeriod[keyof typeof UsersIdBudgetSummaryGetPeriod];
/**
 * @export
 */
...
export type UsersIdTrendAnalysisGetPeriod = typeof UsersIdTrendAnalysisGetPeriod[keyof typeof UsersIdTrendAnalysisGetPeriod];
