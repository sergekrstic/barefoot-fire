...
export const UsersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        usersIdPut: async (id: number, usersIdPutRequest?: UsersIdPutRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
...
export const UsersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async meGet(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<User>> {
         ...
         * @throws {RequiredError}
         */
        async usersIdPut(id: number, usersIdPutRequest?: UsersIdPutRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<User>> {
...
export const UsersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        usersIdPut(requestParameters: UsersApiUsersIdPutRequest, options?: RawAxiosRequestConfig): AxiosPromise<User> {
            return localVarFp.usersIdPut(requestParameters.id, requestParameters.usersIdPutRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class UsersApi extends BaseAPI {
    ...
    public usersIdPut(requestParameters: UsersApiUsersIdPutRequest, options?: RawAxiosRequestConfig) {
        return UsersApiFp(this.configuration).usersIdPut(requestParameters.id, requestParameters.usersIdPutRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
