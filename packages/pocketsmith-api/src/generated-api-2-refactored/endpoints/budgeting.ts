...
import { BudgetAnalysisPackage } from '../generated-api-2-refactored/types/api.types'
...
export const BudgetingApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     */
    usersIdBudgetGet: async (id: number, rollUp?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    usersIdForecastCacheDelete: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
...
export const BudgetingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    usersIdBudgetGet(id: number, rollUp?: boolean, options?: any): AxiosPromise<Array<BudgetAnalysisPackage>> {
      return localVarFp.usersIdBudgetGet(id, rollUp, options).then((request) => request(axios, basePath))
    },
    /**
     * Get the user\'s budget summary, containing an expense and income analysis for all categories (excluding transfer categories) for the given period and date range. Akin to the overall budget shown on the Budget page in PocketSmith.
     * @summary Get budget summary for user
    ...
    usersIdBudgetSummaryGet(
      ...
      return localVarFp
        .usersIdBudgetSummaryGet(id, period, interval, startDate, endDate, options)
    ...
    usersIdForecastCacheDelete(id: number, options?: any): AxiosPromise<void> {
      return localVarFp.usersIdForecastCacheDelete(id, options).then((request) => request(axios, basePath))
    },
    /**
     * Get an income and/or expense budget analysis for the given date range and period across any number of categories and scenarios. Akin to the Trends page in PocketSmith.
     * @summary Get trend analysis for user
    ...
    usersIdTrendAnalysisGet(
      ...
      return localVarFp
        .usersIdTrendAnalysisGet(id, period, interval, startDate, endDate, categories, scenarios, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class BudgetingApi extends BaseAPI {
   ...
   */
  public usersIdBudgetGet(id: number, rollUp?: boolean, options?: AxiosRequestConfig) {
