...
export const AttachmentsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    attachmentsIdDelete: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
    ...
    attachmentsIdGet: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
    ...
    transactionsIdAttachmentsGet: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
...
export const AttachmentsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async attachmentsIdPut(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.attachmentsIdPut(
        id,
        attachmentsIdDeleteRequest,
        options,
      )
...
export const AttachmentsApiFactory = function (
  ...
  return {
    ...
    transactionsIdAttachmentsGet(id: number, options?: any): AxiosPromise<Array<Attachment>> {
      return localVarFp.transactionsIdAttachmentsGet(id, options).then((request) => request(axios, basePath))
    },
    transactionsIdAttachmentsPost(
      ...
      return localVarFp
        .transactionsIdAttachmentsPost(id, transactionsIdAttachmentsGetRequest, options)
        .then((request) => request(axios, basePath))
    },
    transactionsTransactionIdAttachmentsAttachmentIdDelete(
      ...
      return localVarFp
        .transactionsTransactionIdAttachmentsAttachmentIdDelete(transactionId, attachmentId, options)
        .then((request) => request(axios, basePath))
    },
    usersIdAttachmentsGet(id: number, unassigned?: number, options?: any): AxiosPromise<Array<Attachment>> {
      return localVarFp.usersIdAttachmentsGet(id, unassigned, options).then((request) => request(axios, basePath))
    },
...
export class AttachmentsApi extends BaseAPI {
   ...
   * @memberof AttachmentsApi
   */
  public transactionsIdAttachmentsGet(id: number, options?: AxiosRequestConfig) {
    return AttachmentsApiFp(this.configuration)
   ...
   * @memberof AttachmentsApi
   */
  public usersIdAttachmentsGet(id: number, unassigned?: number, options?: AxiosRequestConfig) {
    return AttachmentsApiFp(this.configuration)
