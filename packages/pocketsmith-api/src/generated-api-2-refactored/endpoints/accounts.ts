...
export const AccountsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    accountsIdDelete: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
    ...
    accountsIdGet: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
    ...
    institutionsIdAccountsGet: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
    ...
    usersIdAccountsGet: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
...
export function AccountsApiFp(configuration?: Configuration) {
  ...
  return {
    ...
    async accountsIdPut(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.accountsIdPut(id, accountsIdDeleteRequest, options)
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
    },
...
export const AccountsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    accountsIdDelete(id: number, options?: any): AxiosPromise<void> {
      return localVarFp.accountsIdDelete(id, options).then((request) => request(axios, basePath))
    },
    accountsIdGet(id: number, options?: any): AxiosPromise<Account> {
      return localVarFp.accountsIdGet(id, options).then((request) => request(axios, basePath))
    },
    accountsIdPut(id: number, accountsIdDeleteRequest?: AccountsIdDeleteRequest, options?: any): AxiosPromise<Account> {
      return localVarFp.accountsIdPut(id, accountsIdDeleteRequest, options).then((request) => request(axios, basePath))
    },
    institutionsIdAccountsGet(id: number, options?: any): AxiosPromise<Array<Account>> {
      return localVarFp.institutionsIdAccountsGet(id, options).then((request) => request(axios, basePath))
    },
    usersIdAccountsGet(id: number, options?: any): AxiosPromise<Array<Account>> {
      return localVarFp.usersIdAccountsGet(id, options).then((request) => request(axios, basePath))
    },
    usersIdAccountsPost(
      id: number,
      usersIdAccountsGetRequest1?: UsersIdAccountsGetRequest1,
...
export class AccountsApi extends BaseAPI {
   ...
   * @memberof AccountsApi
   */
  public accountsIdPut(id: number, accountsIdDeleteRequest?: AccountsIdDeleteRequest, options?: AxiosRequestConfig) {
    return AccountsApiFp(this.configuration)
