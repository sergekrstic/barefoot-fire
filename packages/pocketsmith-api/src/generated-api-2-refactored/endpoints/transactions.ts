...
export const TransactionsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    transactionsIdDelete: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
     ...
     * @throws {RequiredError}
     */
    transactionsIdGet: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
...
export const TransactionsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async transactionsIdPut(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.transactionsIdPut(
        id,
        transactionsIdDeleteRequest,
        options,
      )
...
export const TransactionsApiFactory = function (
  ...
  return {
    ...
    transactionAccountsIdTransactionsPost(
      ...
      return localVarFp
        .transactionAccountsIdTransactionsPost(id, transactionAccountsIdTransactionsGetRequest, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Deletes a transaction and all its data by ID.
    ...
    transactionsIdDelete(id: number, options?: any): AxiosPromise<void> {
      return localVarFp.transactionsIdDelete(id, options).then((request) => request(axios, basePath))
    },
    /**
     * Gets a transaction by its ID.
     * @summary Get a transaction
    ...
    transactionsIdGet(id: number, options?: any): AxiosPromise<Transaction> {
      return localVarFp.transactionsIdGet(id, options).then((request) => request(axios, basePath))
    },
    /**
     * Updates a transaction by its ID.
     * @summary Update a transaction
