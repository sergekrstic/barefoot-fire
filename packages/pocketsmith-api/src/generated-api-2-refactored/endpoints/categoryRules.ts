...
import { CategoriesIdCategoryRulesPostRequest, CategoryRule } from '../generated-api-2-refactored/types/api.types'
...
export const CategoryRulesApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    usersIdCategoryRulesGet: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
...
export const CategoryRulesApiFactory = function (
  ...
  return {
    ...
    categoriesIdCategoryRulesPost(
      ...
      return localVarFp
        .categoriesIdCategoryRulesPost(id, categoriesIdCategoryRulesPostRequest, options)
     ...
     * @throws {RequiredError}
     */
    usersIdCategoryRulesGet(id: number, options?: any): AxiosPromise<Array<CategoryRule>> {
      return localVarFp.usersIdCategoryRulesGet(id, options).then((request) => request(axios, basePath))
    },
  }
}
