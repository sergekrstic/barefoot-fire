...
export const InstitutionsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    institutionsIdGet: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
     ...
     * @throws {RequiredError}
     */
    usersIdInstitutionsGet: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
...
export const InstitutionsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async institutionsIdPut(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.institutionsIdPut(
        id,
        institutionsIdDeleteRequest,
        options,
      )
...
export const InstitutionsApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    institutionsIdDelete(id: number, mergeIntoInstitutionId?: number, options?: any): AxiosPromise<void> {
      return localVarFp
    ...
    institutionsIdGet(id: number, options?: any): AxiosPromise<Institution> {
      return localVarFp.institutionsIdGet(id, options).then((request) => request(axios, basePath))
    },
    /**
     * Updates the title and currency code for an institution.
     * @summary Update institution
     ...
     * @throws {RequiredError}
     */
    usersIdInstitutionsGet(id: number, options?: any): AxiosPromise<Array<Institution>> {
      return localVarFp.usersIdInstitutionsGet(id, options).then((request) => request(axios, basePath))
    },
    /**
     * Creates an institution belonging to a user.
     * @summary Create institution in user
...
export class InstitutionsApi extends BaseAPI {
   ...
   */
  public institutionsIdDelete(id: number, mergeIntoInstitutionId?: number, options?: AxiosRequestConfig) {
