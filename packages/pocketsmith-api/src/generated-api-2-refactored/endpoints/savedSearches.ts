...
import { SavedSearch } from '../generated-api-2-refactored/types/api.types'
...
export const SavedSearchesApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     */
    usersIdSavedSearchesGet: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const SavedSearchesApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    usersIdSavedSearchesGet(id: number, options?: any): AxiosPromise<Array<SavedSearch>> {
      return localVarFp.usersIdSavedSearchesGet(id, options).then((request) => request(axios, basePath))
    },
  }
}
