  ...
  return {
    ...
    async currenciesGet(
      ...
      const localVarOperationServerBasePath =
        operationServerMap['CurrenciesApi.currenciesGet']?.[localVarOperationServerIndex]?.url
    ...
    async currenciesIdGet(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['CurrenciesApi.currenciesIdGet']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const CurrenciesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
     ...
     */
    currenciesIdGet(
      requestParameters: CurrenciesApiCurrenciesIdGetRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<Currency> {
...
export class CurrenciesApi extends BaseAPI {
  ...
  public currenciesIdGet(requestParameters: CurrenciesApiCurrenciesIdGetRequest, options?: RawAxiosRequestConfig) {
    return CurrenciesApiFp(this.configuration)
      .currenciesIdGet(requestParameters.id, options)
      .then((request) => request(this.axios, this.basePath))
  }
}
